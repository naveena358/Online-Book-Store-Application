<?php
			...
			$query = "SELECT * FROM books WHERE book_isbn LIKE '%".$keyword."%' OR book_title LIKE '%".$keyword."%' OR book_author LIKE '%".$keyword."%' OR book_publisher LIKE '%".$keyword."%' OR book_desc LIKE '%".$keyword."%'";
			//echo  $query; exit;
			$rs = $db->query($query);
			if($rs->num_rows > 0)
			{
        		...
        		<div class="row">
        			...
        			<div class="col-lg-9 col-12 order-1 order-lg-2">
        				<div class="row">
									...
									<div class="col-lg-12" style="height:50px; color:#0773ea;">
										<?php

										if(count($books_array)) {
										  echo "Total ".count($books_array)." book(s) found for your search.";
									  } else {
											echo "<center>No books found for your search</center>";
										}
